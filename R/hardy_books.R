...
hardy_books <- function(){
  dplyr::bind_rows(dplyr::data_frame(text = maddingcrowd, book = "Far from the Madding Crowd"),
                   dplyr::data_frame(text = native, book = "The Return of the Native"),
                   dplyr::data_frame(text = mayor, book = "The Mayor of Casterbridge"),
                   dplyr::data_frame(text = woodlanders, book = "The Woodlanders"),
                   dplyr::data_frame(text = tess, book = "Tess of the D'Urbervilles"),
                   dplyr::data_frame(text = jude, book = "Jude the Obscure")) %>%
